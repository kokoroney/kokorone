        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <MenuCard 
              title="お試し 45分"
              price="4,000円"
              desc="頭皮の緊張を解きほぐし、眼精疲労の緩和や睡眠の質の向上を目指します。オイルを使用しないリフレッシュケアです。"
            />
          </motion.div>
          ...
          >
            ...
            <div className="bg-brand-100/50 rounded-2xl p-8 md:p-12 border border-brand-200">
              <ul className="space-y-8">
                <InfoItem icon={<MapPin className="w-5 h-5" />} title="出張エリア">
                  高知県内<br/>
                  <span className="text-sm text-brand-600 mt-1 inline-block">※交通費：基本1,000円（遠方の場合はご相談ください）</span>
                </InfoItem>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="mb-12 tracking-wider leading-relaxed text-brand-200 text-sm md:text-base">
              ...
              ご予約・お問い合わせは、LINEまたはお電話にて承っております。<br className="hidden md:block"/>
              <span className="text-xs md:text-sm text-brand-300 mt-4 inline-block">※施術中は電話に出られない場合がございます。LINEでのご連絡を推奨しております。</span>
            </p>
